...
function UpdateGrouptChatModel({fetchMessages,fetchAgain, setFetchAgain }) 
{
  ...
  const handleRemove = async (user1) => 
  {
    ...
    try 
    {
        ...
        const { data } = await axios.put(
            `https://real-time-chat-app-t6sb.onrender.com/api/chat/groupremove`,
            {
        ...
        socket.emit("userRemovedFromGroup", { chatId: selectedChat._id, userId: user1._id });
  ...
  const handleAddUser = async (user1) => 
  {
        ...
        try 
        {
            ...
            const { data } = await axios.put(
                `https://real-time-chat-app-t6sb.onrender.com/api/chat/groupadd`,
                {
                    chatId: selectedChat._id,
                    userId: user1._id,
                },
  ...
  const handleRename = async()=>
  {
    ...
    try 
    {
        ...
        const { data } = await axios.put(
            `https://real-time-chat-app-t6sb.onrender.com/api/chat/rename`,
            {
                chatId: selectedChat._id,
...
export default UpdateGrouptChatModel